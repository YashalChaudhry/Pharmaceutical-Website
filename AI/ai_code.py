...
training = pd.read_csv(os.path.join(current_dir, 'Files', 'Training.csv'))
testing = pd.read_csv(os.path.join(current_dir, 'Files', 'Testing.csv'))
...
#print("----------------------------------------------------------------------------------------")
# Only run the Flask app if needed (not in this script, but in api.py)
